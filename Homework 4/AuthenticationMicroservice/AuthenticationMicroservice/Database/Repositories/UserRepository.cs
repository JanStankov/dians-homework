...
namespace AuthenticationMicroservice.Database.Repositories
{
    public class UserRepository : IUserRepository
    {
        private AuthenticationMicroserviceDbContext _context;
        private readonly IPasswordHasher _passwordHasher;

        public UserRepository(AuthenticationMicroserviceDbContext context, IPasswordHasher passwordHasher)
        {
            _context = context;
